...
namespace Sprites
{
    ...
    {
        public enum DIRECTION { LEFT, RIGHT, UP, DOWN, STANDING }; //enum. very low process time and easier to identify than int
        ...
        {   //draws player info alongside the player, player is drawn in Game1 class
